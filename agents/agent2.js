...
/**
 * runAgent2(message, contexts, username)
 ...
 */
export async function runAgent2(message, contexts = [], username = "unknown") {
  ...
  messages.push({ role: "system", content: "Du bist Agent2, der sich darüber auskennt zum thema geistig / Intellektuel, zb. wissen bildung und lernen." });


  // Option: Du kannst auch eine kurze system-Message mit meta-info hinzufügen
  messages.push({ role: "system", content: `Conversation for user: ${username}, agent: agent2` });
