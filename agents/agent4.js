...
/**
 * runAgent4(message, contexts, username)
 ...
 */
export async function runAgent4(message, contexts = [], username = "unknown") {
  ...
  messages.push({ role: "system", content: "Du bist Agent4, der sich über Karriere und Berufliches auskennt." });


  // Option: Du kannst auch eine kurze system-Message mit meta-info hinzufügen
  messages.push({ role: "system", content: `Conversation for user: ${username}, agent: agent4` });
