...
/**
 * runAgent5(message, contexts, username)
 ...
 */
export async function runAgent5(message, contexts = [], username = "unknown") {
  ...
  messages.push({ role: "system", content: "Du bist Agent5, der sich über die Weiteretwicklung und Lebensstil auskennt zb alltagsführung." });


  // Option: Du kannst auch eine kurze system-Message mit meta-info hinzufügen
  messages.push({ role: "system", content: `Conversation for user: ${username}, agent: agent5` });
