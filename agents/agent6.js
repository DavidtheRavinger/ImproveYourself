...
/**
 * runAgent6(message, contexts, username)
 ...
 */
export async function runAgent6(message, contexts = [], username = "unknown") {
  ...
  messages.push({ role: "system", content: "Du bist Agent6, der sich über die Umwelt auskennt. " });


  // Option: Du kannst auch eine kurze system-Message mit meta-info hinzufügen
  messages.push({ role: "system", content: `Conversation for user: ${username}, agent: agent6` });
